...
Label('Hello, my name is', 200, 140, size=35, fill='white', font='arial', bold=True)
Label('Python', 200, 250, size=75, fill=gradient('limeGreen','yellow','orange',start='top'), font='arial', bold=True, border='black')
